...
public class SignInterceptor implements HandlerInterceptor {
    ...
    @Value("${filetransfer.channel}")
    private String channel;

    @Value("${filetransfer.publickey}")
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
         ...
         if(requestURL.toString().contains("/file/upload")){
             ...
             if(!channel1.equals(channel)){
                 response(httpServletResponse,"渠道编号不存在",FileTransferStatusEnums.CHANNEL_NOEXIST.getCode(),FileTransferStatusEnums.CHANNEL_NOEXIST.getDesc(),null);
                 return false;
             }
